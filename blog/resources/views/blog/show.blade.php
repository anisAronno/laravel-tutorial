...
<div class="container mx-auto flex flex-wrap py-6">
    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <div class="w-full flex justify-between pt-6">
            ...
            <a href="{{ route('blog.show', $blog->previous->id) }}" class="w-1/2 bg-white shadow hover:shadow-md text-left p-6">
            ...
            @if (isset($blog->next))
            <a href="{{ route('blog.show', $blog->next->id) }}" class="w-1/2 bg-white shadow hover:shadow-md text-right p-6">
